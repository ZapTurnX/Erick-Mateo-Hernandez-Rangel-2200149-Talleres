...
form.addEventListener("submit", e=>{
    ...
    if(Name.value.length > 25 || Name.value.length == 0 ){
        ...
        warnings += "Numero de caracteres invalido: Nombre [1 a 25 carácteres] <br>"
        entrar = true
    ...
    if(lastname.value.length > 25 || lastname.value.length == 0){
        ...
        warnings += "Numero de caracteres invalido: Apellido [1 a 25 carácteres] <br>"
        entrar = true
    ...
    if(iu.value.length < 9 || iu.value.length > 21){
        ...
        warnings += "Numero de caracteres invalido: Usuario [10 a 20 carácteres] <br>"
        entrar = true
    ...
    if(direccion.value.length == 0){
        ...
        warnings += "Direccion incompleta <br>"
        entrar = true
